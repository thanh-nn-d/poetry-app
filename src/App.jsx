...
<Route path="/" element={<Login/>}/><Route path="/student/assessment" element={<Assessment/>}/><Route path="/student/assessment/reading" element={<ReadingTest/>}/><Route path="/student/texts" element={<TextSelection/>}/><Route path="/student/text-selection" element={<TextSelection/>}/><Route path="/student/learning" element={<LearningWorkspace/>}/><Route path="/student/summary" element={<LearningSummary/>}/><Route path="/student/learning-summary" element={<LearningSummary/>}/><Route path="/student/challenge" element={<Challenge/>}/><Route path="/student/challenge-result" element={<ChallengeResult/>}/><Route path="/student/profile" element={<LearningProfile/>}/>
