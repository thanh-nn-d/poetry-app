  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/student/text-selection" element={<TextSelection />} />
        <Route path="/student/learning" element={<LearningWorkspace />} />
        <Route path="/student/summary" element={<LearningSummary />} />
        <Route path="/student/learning-summary" element={<LearningSummary />} />
        <Route path="/student/challenge" element={<Challenge />} />
        <Route path="/student/challenge-result" element={<ChallengeResult />} />
        <Route path="/student/profile" element={<LearningProfile />} />

        {/* Teacher */}
        <Route path="/teacher" element={<Dashboard />} />
        <Route path="/teacher/students" element={<StudentProfile />} />
        <Route path="/teacher/feedback" element={<Feedback />} />
        <Route path="/teacher/grading" element={<Grading />} />
        <Route path="/teacher/assessment-result" element={<AssessmentResult />} />
