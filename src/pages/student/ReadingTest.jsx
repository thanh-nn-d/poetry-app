    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          {question.afterQuote && (
            <p className="mt-2 text-[17px] leading-8 text-gray-800 md:text-[18px]">
              {question.afterQuote}
            </p>
          )}
      ...
      <textarea
        ...
        rows={question.rows}
        className={`mt-5 w-full resize-y rounded-2xl border px-5 py-4 text-[16px] leading-7 outline-none transition ${
          disabled
            ? "cursor-not-allowed border-gray-200 bg-gray-100 text-gray-500"
            : "border-gray-200 bg-[#fffdf9] text-gray-800 placeholder:text-gray-400 focus:border-[#8f1d2c] focus:ring-2 focus:ring-[#8f1d2c]/10"
        }`}
      />

      {disabled && (
        <p className="mt-2 text-xs text-gray-400">
          Câu trả lời đã được ghi nhận và không thể chỉnh sửa.
        </p>
      )}
    </div>
  )
      ...
      <div className="px-6 py-10 md:px-12">
        <div className="mx-auto max-w-4xl">
          ...
          >
            {/* KHỔ 1 */}
            <div className="mb-9">
              <p>Đêm mưa làm nhớ không gian,</p>
              <p>Lòng run thêm lạnh nỗi hàn bao la...</p>
            </div>

            {/* KHỔ 2 */}
            <div className="mb-9">
              <p>Tai nương nước giọt mái nhà</p>
            ...
            {/* KHỔ 3 */}
            <div className="mb-9">
              <p>Rơi rơi... dìu dịu rơi rơi...</p>
              <p>Trăm muôn giọt nhẹ nối lời vu vơ...</p>
            </div>
            ...
            <div>
              ...
              <p>Gió về, lòng rộng không che,</p>

              <p>Hơi may hiu hắt bốn bề tâm tư…</p>
            </div>
          </div>

          {/* NGUỒN */}
          <div
            className="mt-8 text-right text-[17px] leading-7 text-gray-800"
            style={{
              fontFamily: '"Times New Roman", Times, serif',
            }}
          >
          ...
          <div className="mt-6 border border-gray-400 bg-[#fffdf9] px-6 py-5">
            ...
            >
              <strong>Huy Cận</strong> tên thật là{" "}
              <strong>Cù Huy Cận</strong>{" "}
              <strong>(1919 - 2005)</strong>. Ông là một trong
              những gương mặt tiêu biểu của{" "}
              <strong>phong trào Thơ mới</strong>, nổi bật với
              phong cách thơ buồn ảo não, triết lý, cô đơn, giàu
              cảm xúc. Văn bản{" "}
              <strong>
                <em>Buồn đêm mưa</em>
              </strong>{" "}
...
function ReadingTest() {
  ...
  const [beforeReadingCompleted, setBeforeReadingCompleted] =
    useState(false)
  ...
  const beforeReadingAnswered =
    Boolean(answers.C1?.trim()) &&
    Boolean(answers.C2?.trim())
  ...
  const handleContinueToPoem = () => {
    if (!beforeReadingAnswered) return

    setBeforeReadingCompleted(true)
  }
  ...
  const handleChange = (questionId, value) => {
    // Không cho sửa C1/C2 sau khi đã chuyển sang bài thơ
    if (
      beforeReadingCompleted &&
      (questionId === "C1" || questionId === "C2")
    ) {
      return
    }
  ...
  return (
    <div className="min-h-screen bg-[#faf8f3]">
      ...
      <main className="mx-auto max-w-6xl px-6 py-8">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
                Trả lời hai câu hỏi trước khi đọc. Sau khi hoàn thành
                và chọn Tiếp theo, văn bản sẽ được mở.
              </p>
            </div>
        ...
        {!beforeReadingCompleted && (
          <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#eadfd5] md:p-8">
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                Hãy trả lời cả hai câu hỏi. Sau đó chọn Tiếp theo để
                bắt đầu đọc văn bản.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col items-end gap-2 border-t border-[#eadfd5] pt-6">
              {!beforeReadingAnswered && (
                <p className="w-full text-sm text-gray-500">
                  Hãy hoàn thành cả C1 và C2 để tiếp tục.
                </p>
              )}

              <button
                type="button"
                onClick={handleContinueToPoem}
                disabled={!beforeReadingAnswered}
        ...
        {beforeReadingCompleted && (
          <>
            ...
            <section className="mb-6 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#eadfd5] md:p-8">
            ...
            <section className="mb-6 rounded-3xl border border-[#d8c6a3] bg-[#fffaf0] px-6 py-5 shadow-sm">
              <div className="flex items-center gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#8f1d2c] text-lg font-bold text-white">
                  ✓
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Em hãy đọc văn bản và tiếp tục trả lời các câu hỏi.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="grid gap-6 lg:h-[calc(100vh-10rem)] lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
              {/* ================= VĂN BẢN ================= */}
              ...
              <div className="min-h-0 overflow-y-auto rounded-3xl">
                {/* TRONG QUÁ TRÌNH ĐỌC */}
                <section className="mb-6 overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-[#eadfd5]">
                  <div className="border-b border-[#eadfd5] bg-[#fffdf9] px-6 py-5 md:px-8">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Trả lời các câu hỏi dựa trên những chi tiết
                      trong văn bản.
                    </p>
                  </div>
                  ...
                  <div className="space-y-5 p-5 md:p-6">
                    {duringReadingQuestions.map((question) => (
                      <div key={question.id}>
                        <span className="mb-3 inline-flex rounded-full bg-[#e7eef7] px-4 py-1.5 text-sm font-bold text-[#526b87]">
                          {question.category}
                        </span>
